# -*- coding: utf-8 -*-
"""
SNEkhorn and TSNEkhorn algorithms (inverse OT DR)
"""
...
class SNEkhorn(BaseSNEkhorn):
    """
    SNEkhorn algorithm proposed in [3]_.
    ...
    def __init__(self, **kwargs):
        super().__init__(base_kernel="gaussian", **kwargs)


class TSNEkhorn(BaseSNEkhorn):
    """
    TSNEkhorn algorithm proposed in [3]_.
    ...
    def __init__(self, **kwargs):
        super().__init__(base_kernel="student", **kwargs)
