...
class TestAffinityMatcherDataLoader:
    ...
    def test_affinity_matcher_dataloader_metadata(self, sample_data, dataloader):
        ...
        from torchdr.affinity import SparseGibbsAffinity
        from torchdr.affinity_matcher import AffinityMatcher

        # Create AffinityMatcher with sparse affinity (uses FAISS for k-NN)
        model = AffinityMatcher(
            affinity_in=SparseGibbsAffinity(k=10, backend="faiss"),
            affinity_out=None,
            n_components=2,
