...
def test_knn_label_accuracy_perfect(dtype, backend, k):
    """Test knn_label_accuracy with well-separated classes."""
    n_per_class = 50
    n_classes = 3
...
def test_knn_label_accuracy_random(dtype, backend):
    """Test knn_label_accuracy with random data."""
    n = 100
    k = 10
...
def test_knn_label_accuracy_per_sample(dtype, backend):
    """Test knn_label_accuracy per-sample output."""
    n = 100
    k = 10
...
def test_knn_label_accuracy_numpy(dtype):
    """Test knn_label_accuracy with numpy arrays."""
    n = 100
    k = 10
...
def test_knn_label_accuracy_errors():
    """Test knn_label_accuracy error handling."""
    n = 100
    X = torch.randn(n, 20)
