...
from torchdr import PCA, UMAP, InfoTSNE, LargeVis, PACMAP
...
scatter = axes[0].scatter(z_umap[:, 0], z_umap[:, 1], c=y, cmap="tab10", s=1, alpha=0.3)
...
axes[3].scatter(z_pacmap[:, 0], z_pacmap[:, 1], c=y, cmap="tab10", s=1, alpha=0.3)
